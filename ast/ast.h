...
ast_program_t
ast_program_new(ast_globals_t globals, ast_tasks_t tasks, ast_scheduler_t
   scheduler);

ast_globals_t
ast_globals_new(ast_global_t global);
...
ast_variables_t
ast_variables_add(ast_variables_t variables, ast_variable_t variable);

ast_variable_t
ast_variable_new(char * name);

ast_code_t
ast_code_new(ast_code_child_t child);
...
ast_scheduler_t
ast_scheduler_new(ast_scheduled_task_t scheduled_task);

ast_scheduler_t
ast_scheduler_add(ast_scheduler_t scheduler, ast_scheduled_task_t scheduled_task);
